...
import { PrivateDnsNamespaceAttributes } from "aws-cdk-lib/aws-servicediscovery/lib/private-dns-namespace";
...
export const getVpcId = (landingZoneAccountType: LandingZoneAccountType): string => {
  return landingZoneAccountType === LandingZoneAccountType.PROD ? "vpc-09d085203fb33443c" : "vpc-0ed78d1d0d9b9015e";
};
 ...
 * @param landingZoneAccountType
 */
export const getVpcSubnetIds = (subnetType: SubnetType, landingZoneAccountType?: LandingZoneAccountType): string[] => {
 ...
 * @param subnetType
 */
export const getVpcSubnets = (scope: Construct, id: string, subnetType: SubnetType, landingZoneAccountType?: LandingZoneAccountType): ISubnet[] => {
 ...
 * @param landingZoneAccountType
 */
export const getPrivateDnsNamespaceAttributes = (landingZoneAccountType?: LandingZoneAccountType): PrivateDnsNamespaceAttributes => {
  if (landingZoneAccountType === LandingZoneAccountType.PROD) {
    return {
      namespaceName: "fws.ofr.cruk.private",
      namespaceId: "ns-zqptbyi24mee2cca",
      namespaceArn: "arn:aws:servicediscovery:eu-west-2:921806190493:namespace/ns-zqptbyi24mee2cca",
    };
  }
  return {
    namespaceName: "fws.ofr.cruk.private",
    namespaceId: "ns-7sl2wvtrkgsm7xwo",
    namespaceArn: "arn:aws:servicediscovery:eu-west-2:651948078005:namespace/ns-7sl2wvtrkgsm7xwo",
  };
};
